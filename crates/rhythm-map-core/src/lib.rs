...
pub use types::{
    ...
    ChangeKind, ChangePoint, MetricalAmbiguityRegion, ModelInfo, ObservedBeat,
    RhythmActivationSeries, RhythmObservations, RhythmSection, TempoHypothesis, TempoPoint,
